...
function Tile(props) {
    ...
    const handleClose = () =>{
        setClicked(false);
        tileRef.current.style.height = '15rem';
        tileRef.current.style.width = '10rem';
